...
public class USPreferences extends Object {
    protected static USPreferences instance = null;
    public synchronized static USPreferences getInstance(Context context) {
        if (instance == null) {
            instance = new USPreferences(context);
        }
        return instance;
    }
    protected Context context;
    SharedPreferences thePrefs;
    protected USPreferences(Context con) {
        if (context == null) {
            context = con;
